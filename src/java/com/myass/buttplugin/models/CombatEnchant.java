...
public abstract class CombatEnchant extends CustomEnchant{
  ...
  public abstract void onAttack(int level, LivingEntity attacker, LivingEntity defender);
  public abstract void onDefend(int level, LivingEntity attacker, LivingEntity defender);
